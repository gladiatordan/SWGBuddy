...
class CacheManager:
	...
	def __new__(cls, *args, **kwargs):
		if cls._instance is None:
			...
			# We will initialize the shared dictionary container here,
			# but the actual Manager needs to be managed carefully.
	...
	def initialize(self):
		...
		# Create the manager only once in the main process
		if CacheManager._manager is None:
			CacheManager._manager = Manager()
		
		# Initialize the shared dict proxy
