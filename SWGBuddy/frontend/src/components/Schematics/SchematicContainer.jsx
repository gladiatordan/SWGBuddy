...
const SchematicContainer = () => {
    ...
    const fetchDetailsForTab = async (schematic, tabId) => {
        ...
        try {
            // Simulate Fetch
            setTimeout(() => {
                // In prod, this comes from the JSON file generated by python
                // We mock the structure here to match the Python script output
                const rawData = {
                    ...
                    // The Rankings Object (Mocked, normally populated by Python)
                    "rankings": {
                         "fruit": {
                             "exp_experimental_flavor": {
                                 "best": [], // IDs would go here
                                 "current": []
                             }
                             // ... other combos
                         }
